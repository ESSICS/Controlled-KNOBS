 ...
 */
public class ControlledKnobBuilderTest extends ApplicationTest {

    private static final Logger LOGGER = Logger.getLogger(ControlledKnobBuilderTest.class.getName());
    ...
    public void testBackgroundColor() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().backgroundColor(value);
    ...
    public void testBuild() {
        ...
        assertThat(knob1)
            ...
            .hasFieldOrPropertyWithValue("tagColor", Color.YELLOW)
    ...
    public void testColor() {
        ...
        Color value = Color.GOLDENROD;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().color(value);
    ...
    public void testCreate() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create();
    ...
    public void testCurrentValue() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().currentValue(value);
    ...
    public void testCurrentValueColor() {
        ...
        Color value = Color.GOLDENROD;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().currentValueColor(value);
    ...
    public void testDecimals() {
        ...
        int value = 3;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().decimals(value);
    ...
    public void testDragDisabled() {
        ...
        boolean value = true;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().dragDisabled(value);
    ...
    public void testExtremaVisible() {
        ...
        boolean value = true;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().extremaVisible(value);
    ...
    public void testGradientStops() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().gradientStops(value);
        ...
        builder = ControlledKnobBuilder.create().gradientStops(stop2, stop3, stop1);
        ...
        builder = ControlledKnobBuilder.create().gradientStops((List<Stop>) null);
    ...
    public void testID() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().id(value);
    ...
    public void testIndicatorColor() {
        ...
        Color value = Color.GOLDENROD;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().indicatorColor(value);
    ...
    public void testLayoutX() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().layoutX(value);
    ...
    public void testLayoutY() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().layoutY(value);
    ...
    public void testMaxHeight() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().maxHeight(value);
    ...
    public void testMaxSize() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().maxSize(width, height);
    ...
    public void testMaxValue() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().maxValue(value);
    ...
    public void testMaxWidth() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().maxWidth(value);
    ...
    public void testMinHeight() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().minHeight(value);
    ...
    public void testMinSize() {
        ...
        double width = 123.456;
        double height = 234.567;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().minSize(width, height);
    ...
    public void testMinValue() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().minValue(value);
    ...
    public void testMinWidth() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().minWidth(value);
    ...
    public void testOnAdjusted() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().onAdjusted(value);
    ...
    public void testOnAdjusting() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().onAdjusting(value);
    ...
    public void testOnTargetSet() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().onTargetSet(value);
    ...
    public void testOpacity() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().opacity(value);
    ...
    public void testPadding() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().padding(insets);
        ...
        builder = ControlledKnobBuilder.create().padding(1, 2, 3, 4);
        ...
        insets = new Insets(7);
        builder = ControlledKnobBuilder.create().padding(7);
    ...
    public void testPrefHeight() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().prefHeight(value);
    ...
    public void testPrefSize() {
        ...
        double width = 123.456;
        double height = 234.567;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().prefSize(width, height);
    ...
    public void testPrefWidth() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().prefWidth(value);
    ...
    public void testScaleX() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().scaleX(value);
    ...
    public void testScaleY() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().scaleY(value);
    ...
    public void testSelected() {
        ...
        boolean value = true;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().selected(value);
    ...
    public void testSelectionColor() {
        ...
        Color value = Color.GOLDENROD;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().selectionColor(value);
    ...
    public void testTagColor() {
        ...
        Color value = Color.GOLDENROD;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().tagColor(value);
    ...
    public void testTargetValue() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().targetValue(value);
    ...
    public void testTargetValueAlwaysVisible() {
        ...
        boolean value = true;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().targetValueAlwaysVisible(value);
    ...
    public void testTextColor() {
        ...
        Color value = Color.GOLDENROD;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().textColor(value);
    ...
    public void testTranslateX() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().translateX(value);
    ...
    public void testTranslateY() {
        ...
        double value = 123.456;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().translateY(value);
    ...
    public void testUnit() {
        ...
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().unit(value);
    ...
    public void testZeroDetentEnabled() {
        ...
        boolean value = true;
        ControlledKnobBuilder builder = ControlledKnobBuilder.create().zeroDetentEnabled(value);
